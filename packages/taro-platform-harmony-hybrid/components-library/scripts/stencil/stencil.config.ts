...
const outputTargets: OutputTarget[] = [
  reactOutputTarget({
    componentCorePackage: '@tarojs/components-harmony-hybrid',
    customElementsDir: 'dist/components',
    includeImportCustomElements: true,
    proxiesFile: './libsrc/react/src/components.ts',
  }),
  vue2OutputTarget({
    componentCorePackage: '@tarojs/components-harmony-hybrid',
    // componentModels: [{
    ...
    customElementsDir: 'dist/components',
    includeImportCustomElements: true,
    proxiesFile: './libsrc/vue2/src/components.ts',
  }),
  vue3OutputTarget({
    componentCorePackage: '@tarojs/components-harmony-hybrid',
    // componentModels: [{
    ...
    customElementsDir: 'dist/components',
    includeImportCustomElements: true,
    proxiesFile: './libsrc/vue3/src/components.ts',
  }),
  {
    type: 'dist',
