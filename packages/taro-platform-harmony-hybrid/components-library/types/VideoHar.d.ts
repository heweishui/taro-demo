...
interface VideoHarProps extends StandardProps {
  /** 要播放视频的宽度,默认px单位
  ...
  /** 当视频大小与 VideoHar 容器大小不一致时，视频的表现形式
   * @default "contain"
   * @supported weapp, alipay, swan, tt, qq, jd, h5, harmony_hybrid
   */
  objectFit?: keyof VideoHarProps.ObjectFit
   ...
   */
  playBtnPosition?: keyof VideoHarProps.PlayBtnPosition
  /** 是否开启播放手势，即双击切换播放/暂停
   * @default false
  ...
  /** VideoHar 播放时宿主退出后台后开启小窗播放，iOS 14 及以上版本支持。开启时首次退出后台后给予弹窗提示用户授权，授权完成后可以到小程序「设置」中重设。支持场景见后台小窗播放
   * @supported tt
   */
   ...
   * @supported weapp, alipay, swan, tt, qq, jd, h5, rn, harmony_hybrid
   */
  onTimeUpdate?: CommonEventFunction<VideoHarProps.onTimeUpdateEventDetail>
  /** 当视频进入和退出全屏时触发
   *
   * @supported h5, rn, harmony_hybrid
   */
  onFullscreenChange?: CommonEventFunction<VideoHarProps.onFullscreenChangeEventDetail>
  /** 视频出现缓冲时触发
   *
   * @supported weapp, swan, tt, qq, jd
   */
  onWaiting?: CommonEventFunction<VideoHarProps.onWaitingEventDetail>
  /** 视频播放出错时触发
   * @supported weapp, alipay, swan, tt, qq, jd, h5, rn, harmony_hybrid
   */
   ...
   */
  onProgress?: CommonEventFunction<VideoHarProps.onProgressEventDetail>
  /** 视频元数据加载完成时触发
   * @supported weapp, swan, tt, jd, rn
   */
  onLoadedMetaData?: CommonEventFunction<VideoHarProps.onLoadedMetaDataEventDetail>
  /**
   * 播放器进入小窗
   * @supported weapp
   */
   ...
   */
  onControlsToggle?: CommonEventFunction<VideoHarProps.onControlsToggleEventDetail>
  /** 视频出现缓冲时触发。
   * @supported alipay
   */
   ...
   * @supported alipay
   */
  onTap?: CommonEventFunction<VideoHarProps.onTapEventDetail>
  /** 用户操作事件
   * @supported alipay
   */
  onUserAction?: CommonEventFunction<VideoHarProps.onUserActionEventDetail>
  /** 视频播放终止。
   * @supported alipay
   */
   ...
   * @supported tt
   */
  onAdStart?: CommonEventFunction<VideoHarProps.onAdTypeCommonEventDetail>
  /** 贴片广告播放结束时触发
   * @supported tt
   */
  onAdEnded?: CommonEventFunction<VideoHarProps.onAdTypeCommonEventDetail>
  /** 贴片广告非自然结束时触发，如：用户关闭广告或广告播放过程中 VideoHar 组件被销毁
   * @supported tt
   */
  onAdClose?: CommonEventFunction<VideoHarProps.onAdTypeCommonEventDetail>
  /** 贴片广告加载失败时触发
   * @supported tt
   */
  onAdError?: CommonEventFunction<VideoHarProps.onAdTypeCommonEventDetail>
...
declare namespace VideoHarProps {
  /** direction 的合法值 */
  interface direction {
    /** 正常竖向 */
    0
...
/** 视频。相关api：Taro.createVideoHarContext
 ...
 */
declare const VideoHar: ComponentType<VideoHarProps>
export { VideoHar, VideoHarProps }
