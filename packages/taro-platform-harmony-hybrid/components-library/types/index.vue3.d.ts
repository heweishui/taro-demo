...
import { VideoProps } from './VideoHar'
...
/** 媒体组件 */
export declare const VideoHar: VueComponentType<VideoProps>
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      ...
      'taro-video-har-core': ElementAttrs<TransformReact2VueType<VideoProps>>
    }
  }
}
